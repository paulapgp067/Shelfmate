...
<head>
    ...
    <title> Mi Shelf: Estantería personal del admin <?php echo filtrado($alias); ?></title>
...
<body>
    ...
    <main class="columnas">
        ...
        <section class="derecha">
            ...
            <!-- SOLO ADMIN -->
            <div class="tablon-label">
                <a href="<?= BASE_URL ?>admin/programarReunion.php?id_club=<?= $id_club ?>">Programar reunión</a>
            </div>

            <div class="tablon-label">
                <a href="<?= BASE_URL ?>admin/mensajes.php?id_usuario=<?= $id_usuario ?>">Notificaciones</a>
            </div>

            <div class="tablon-label">
                <a href="<?= BASE_URL ?>admin/asistencias.php?id_club=<?= $id_club ?>">Consultar asistencias</a>
            </div>
        </section>
    </main>
